#!/bin/bash
# tests/installer/installer-macos-smoke-unit-test.sh — Plan 71 SP08 T-5 (S70 L1 slice)
#
# L1 scope (this slice):
...
# Pattern lifted from tests/orchestrator/integration-orchestration-mock-launchctl.sh.
