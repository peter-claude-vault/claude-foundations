...
assert_path_exists "$CH/hooks/lib/live-guard.sh"             "T1.3a: hooks/lib/live-guard.sh landed (Step 3.5; SP01 T-3)"
assert_path_exists "$CH/hooks/lib/l3-pause-helper.sh"        "T1.3b: hooks/lib/l3-pause-helper.sh landed (Step 3.5; SP01 T-4)"
assert_path_exists "$CH/hooks/lib/l3-writer-registry.json"   "T1.3c: hooks/lib/l3-writer-registry.json landed (Step 3.5; SP01 T-5)"
assert_path_exists "$CH/hooks/lib/gate-schema-migrate.sh"    "T1.3d: hooks/lib/gate-schema-migrate.sh landed (Step 3.5; SP01 T-11)"
