#!/usr/bin/env bash
# tests/sp16/greenfield-end-to-end.sh — SP16 T-3 (Group C, gate C).
#
...
FIXTURE_DIR="$REPO_ROOT/tests/sp16/fixtures/greenfield-seed"
...
#   mirrors what tests/sp12/t16-cross-cutting-smoke-test.sh does for its own
#   per-surface markers.
