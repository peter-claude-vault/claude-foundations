#!/bin/bash
# tests/auto-author/t16-cross-cutting-smoke-test.sh — SP12 T-16 cross-cutting smoke
...
G3_OK=0
if bash "$REPO_ROOT/tests/auto-author/g3-context-pressure-thresholds-test.sh" >/dev/null 2>&1; then
  G3_OK=1
fi
