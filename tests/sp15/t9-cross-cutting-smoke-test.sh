#!/usr/bin/env bash
# tests/sp15/t9-cross-cutting-smoke-test.sh — SP15 T-9 cross-cutting smoke
#
...
T4_TEST="$REPO_ROOT/tests/sp15/t4-surface-3-consultation-test.sh"
T5_TEST="$REPO_ROOT/tests/sp15/t5-surface-4-consultation-test.sh"
T6_TEST="$REPO_ROOT/tests/sp15/t6-surface-6-consultation-test.sh"
T7_TEST="$REPO_ROOT/tests/sp15/t7-stage-2-5-consultation-test.sh"
