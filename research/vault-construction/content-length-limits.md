...
| Narrative spoke (pillar) | Vault: `System Governance/System Governance - <Pillar>.md` | 4–8K | 12K | Progressive-disclosure user read | Reference-deployment range across the seven live spokes: ~3.5K–10K. Target sits in the middle of observed range so spokes fit a single human reading window. Hard cap 12K signals "split by sub-topic if accumulating." |
