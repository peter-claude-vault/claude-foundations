...
emit_pairs() {
  ...
  # templates/ — 3 named files at top
  for f in "$SOURCE_REPO/templates/settings.json" "$SOURCE_REPO/templates/librarian-manifest-skeleton.json" "$SOURCE_REPO/templates/README.md"; do
    [ -f "$f" ] || continue
    base="${f##*/}"
